...
export class EmployeeListPage implements OnInit {
    ...
    constructor(private employeeService: EmployeeService, public modalController: ModalController,
                private routerOutlet: IonRouterOutlet, private authService: AuthenticationService) {
    }

    ngOnInit() {
        this.authService.isAuthenticated().then(authed => console.log('is authed', authed));
